...
export const catalog = {
  ...
  items: [
    ...
    },
    {
      ...
      description: 'Объём копательного ковша 0,3 м³, объём фронтального ковша 1,2 м³. Универсальная машина: экскаваторный ковш сзади, погрузочный — спереди. Для малых объёмов работ.',
      price: 'от 3 200 ₽/час',
      priceNote: 'с оператором'
    },
    {
